...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        ...
        the index page.
        """
        question = create_question(question_text="Future question", days=20)
        response = self.client.get(reverse('polls:index'))
        self.assertContains(response, "No polls are available.")
        self.assertQuerysetEqual(response.context['latest_question_list'], [])
    ...
    def test_future_question_and_past_question(self):
        ...
        """
        question = create_question(question_text="Past question", days=-10)
        create_question(question_text="Fututre question", days=10)
        response = self.client.get(reverse('polls:index'))
...
class QuestionDetailViewTests(TestCase):
    def test_feature_question(self):
        ...
        """
        question = create_question("Future question", days=20)
